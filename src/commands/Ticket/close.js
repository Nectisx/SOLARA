    ...
    async execute(interaction, guildConfig, client) {
        try {
            ...
            if (!permissionContext.canCloseTicket) {
                return await InteractionHelper.safeEditReply(interaction, {
                    embeds: [
                        errorEmbed(
                            "Permission refusée",
                            "Vous avez besoin de la permission `Gérer les salons`, du `Rôle du personnel Ticket` configuré, ou d'être le créateur du ticket pour le fermer.",
                        ),
                    ],
                });
            }
            ...
            const reason =
                ...
                "Fermé via commande sans raison spécifique.";
