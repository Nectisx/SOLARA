        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .addBooleanOption(option =>
                    option.setName('ping')
                        .setDescription('Mentionner l\'utilisateur dans le message d\'au revoir')
                        .setRequired(false))),
    ...
    async execute(interaction) {
        ...
        if (subcommand === 'setup') {
            ...
            if (existingConfig?.goodbyeChannelId) {
                ...
                return await InteractionHelper.safeEditReply(interaction, {
                    embeds: [errorEmbed(
                        'Configuration Au revoir déjà existante',
                        `Au revoir est déjà configuré pour <#${existingConfig.goodbyeChannelId}>. Utilisez **/goodbye config** pour personnaliser le salon, le message, la mention ou l\'image.`
                    )],
                    flags: MessageFlags.Ephemeral
                });
            }
            ...
            try {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setTitle('✅ Système Au revoir configuré')
                    ...
                    .setFooter({ text: 'Astuce : Utilisez /goodbye config pour personnaliser les paramètres d\'au revoir' });
                ...
                await InteractionHelper.safeEditReply(interaction, {
                    embeds: [errorEmbed(
                        ...
                        'Une erreur s\'est produite lors de la configuration du système Au revoir. Veuillez réessayer.',
                        { showDetails: true }
                    )],
                    flags: MessageFlags.Ephemeral
                });
