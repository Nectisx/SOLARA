...
export default {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('dashboard')
                .setDescription('Ouvrir le tableau de bord de configuration bienvenue & au revoir'),
        ),
    ...
    async execute(interaction, config, client) {
        try {
            ...
            if (error instanceof TitanBotError) {
                return await InteractionHelper.safeReply(interaction, {
                    embeds: [errorEmbed('Erreur de configuration', error.userMessage || 'Une erreur s\'est produite.')],
                    flags: MessageFlags.Ephemeral,
                });
            }
